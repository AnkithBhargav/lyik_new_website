...
const PublicSectors = () => {
  ...
  const steps = [
    {
      title: "/images/public1.png",
      desc: "Ensure secure data exchange between institution, staff and student, parents ",
    },
    {
      title: "/images/image2.png",
      desc: "Streamline Operations and cut time, errors and costs",
    },
    {
      title: "/images/image3.png",
      desc: "Access & foster inclusivity by engaging a more diverse range of students",
    },
    {
      title: "/images/image1.png",
      desc: "Implement secure identity verifications  & ensure compliance with data protection laws",
    },
  ];

  const cardData = [
    {
      title: "Adapt to Evolving RBI Regulations",
      desc: "Simplify compliance, ensuring your onboarding, KYC and investment flows remain fully aligned with the latest rules.",
    },
    {
      title: "Unlimited Service Journeys",
    ...
    {
      title: "Seamless NRI Onboarding",
      desc: "Onboard NRIs in minutes, not weeks. We streamline every step of the process—from KYC and FATCA declarations to RBI-compliant documentation—minimising manual intervention and speeding up approvals.",
    },
    {
      title: "Go Paperless with DBU’s",
    ...
    >
      ...
      <Box
        sx={{
          ...
          width: "100%",
          backgroundImage: {
            xs: "url(/images/public_sector.png)",
            sm: "url(/images/public_hero.webp)",
          },
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              fontWeight={600}
            >
              Empower secure data exchange between students, Parents, Alumni,
              faculties and administration with flexible, multi-channel
              experiences, including Self-Guided (DIY), Assisted Onboarding
              Journeys on Web and Mobile for seamless, anytime-anywhere access.
            </Typography>
          </Box>
        </Box>
      </Box>
